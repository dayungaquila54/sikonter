...
# Products Data
$products = $db->getConnection()->prepare("SELECT * FROM products");
$products->execute();
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarBottom">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?=base_url('order') ?>">New Order</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a class="list-group-item active" href="<?=base_url('/order') ?>">Order</a>
        ...
        <div class="col-md-9">
          <h1>New Order</h1>
          <p>Place new order here</p>

          <hr />

          <form action="<?=base_url('processOrder.php') ?>" method="post">
            ...
            <div class="form-group mb-3">
              ...
              <select name="product" id="product" class="form-control">
                ...
                <?php foreach($productsResult->fetch_all() as $data) : ?>
